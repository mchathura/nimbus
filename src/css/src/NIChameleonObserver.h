...
extern NSString* const NIGenericResourceDidChangeNotification;
extern NSString* const NIGenericResourceDidChangeFilePathKey;
extern NSString* const NIGenericResourceDidChangeNameKey;
